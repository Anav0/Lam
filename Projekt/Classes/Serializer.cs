...
namespace Projekt
{
    public class Serializer
    {
        ...
        public void UpdateXmlFile(string filePath, string updatedNodeName, string changedValue)
        {
            try
            {
                ...
                XmlNode myNode = root.SelectSingleNode(updatedNodeName);
                myNode.InnerText = changedValue;
                doc.Save(filePath);
            }
            catch (Exception ex)
            {
